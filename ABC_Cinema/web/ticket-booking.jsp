        ...
        <div class="px-0 pt-4 pb-0 mt-3 mb-3">
          <form id="form">
            ...
            <fieldset>
              ...
              <br>
              <input type="button" name="next-step" class="next-step" value="Proceed to Payment" onclick="location.href='check_out.jsp'"/>
              <input type="button" name="previous-step" class="previous-step" value="Back" onclick="location.href='index.jsp'" />
            </fieldset>
