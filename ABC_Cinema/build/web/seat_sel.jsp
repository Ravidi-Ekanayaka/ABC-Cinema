...
<head>
	...
	<link href="assets/css/seat_css/style.css" rel="stylesheet" type="text/css" media="all" />
	<script src="assets/js/seat_js/jquery-1.11.0.min.js"></script>
	<script src="assets/js/seat_js/jquery.seat-charts.js"></script>
</head>
...
<div class="content">
		...
		<div class="demo">
			...
			<div class="booking-details">
				...
				<ul class="book-right">
					...
					<li>: <b><span id="total">0</span><i> USD </i></b></li>
				</ul>
				<div class="clear"></div>
	...
	<script type="text/javascript" src="assets/js/seat_js/theme-change-seat-sel.js"></script>
	<script src="assets/js/seat_js/jquery.nicescroll.js"></script>
	<script src="assets/js/seat_js/scripts.js"></script>
</body>
