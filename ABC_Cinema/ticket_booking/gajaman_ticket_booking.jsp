<%-- 
    Document   : gajaman_ticket_booking
    Created on : Jan 13, 2023, 2:01:53 PM
                            ...
                            <div class="col-50 payment">
                              <label for="paypal" class="method paypal">
                                ...
                                <div class="radio-input">
                                  ...
                                  <input type="button" name="paypal" value="Paypal"  onclick="location.href='gajaman_check_out.jsp';" />
                                  </div>
                              </label>
                            </div>
                          </div>
